...
\titulo{AGUA: Ferramenta Computacional para Estudo da Evolução de Espécies Virais Baseado no Uso de Códons}
\data{\the\year}
\local{Salvador}
...
% Exemplo de uso:
% \membrodabancadois{Prof. PhD. Alexandre Rafael Lenz}
% \membrodabancadoisies{Universidade do Estado da Bahia - UNEB}
% \membrodabancaum{a}
% \membrodabancaumcentro{b}
\membrodabancadois{Prof. PhD. Alexandre Rafael Lenz}
\membrodabancadoiscentro{Faculdade de Filosofia Dom Aureliano Matos – FAFIDAM}
\membrodabancadoisies{Universidade do Estado da Bahia - UNEB}
\membrodabancatres{Prof. PhD. Maria Inés Restovic}
\membrodabancatrescentro{Centro de Ciências e Tecnologia - CCT}
\membrodabancatresies{Universidade do Estado da Bahia - UNEB}
...
\input{elementos-pos-textuais/anexos/figura_arvores_anexo}
