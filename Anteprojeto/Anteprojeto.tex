...
\acrodef{ngs}[NGS]{Sequenciamento de Nova Geração}
\acrodef{rs}[RS]{Revisão Sistemática}
\acrodef{cafe}[CAFe]{Comunidade Acadêmica Federada}
\acrodef{parsifal}[Parsifal]{Perform Systematic Literature Reviews}
\acrodef{fcgr}[FCGR]{Frequency Chaos Game Representation}
...
\bibliography{RT1.bib}
%\bibliography{RT2.bib}
\end{document}